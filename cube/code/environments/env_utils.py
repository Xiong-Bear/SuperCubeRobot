...
def getEnvironment(envName):
    ...
    if envName == 'cube3':
        from cube.code.environments.cube_interactive_simple import Cube
        ...
        from cube.code.environments.cube_interactive_simple_4 import Cube as Environment
    elif envName == 'cube4d2':
        from cube.code.environments.cube4D import Cube
        Environment = Cube(2)
    elif envName == 'puzzle15':
        from cube.code.environments.puzzleN import PuzzleN
        ...
        from cube.code.environments.LightsOut import LightsOut
        m = re.search('lightsout([\d]+)',envName)
        Environment = LightsOut(int(m.group(1)))
    elif 'hanoi' in envName:
        from cube.code.environments.Hanoi import Hanoi
        ...
        from cube.code.environments.Sokoban import Sokoban
